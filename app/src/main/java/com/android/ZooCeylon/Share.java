...
/**
 * Created by Chinthana on 05/12/2014.
 */
public class Share extends MainActivity {
    ...
    private CharSequence mDrawerTitle="Zoo Ceylon";	// menu drawer title
    private CharSequence mTitle="Share";		// menu title
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setIcon(R.drawable.ic_share);
        // Initializing
    ...
    public void SelectItem(int position)
    {
       ...
       // else
           // Toast.makeText(this, "You are currently on photo and video gallery", Toast.LENGTH_SHORT).show();
