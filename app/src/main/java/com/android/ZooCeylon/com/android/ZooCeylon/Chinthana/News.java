...
public class News extends Activity {private DrawerLayout mDrawerLayout; // defining the drawerLayout
    ...
    CustomDrawerAdapter customDrawerAdapter;		// customDrawerAdapter to link the list items to the navigation bar.
    ...
    protected void onCreate(Bundle savedInstanceState) {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    newsItem.setTitle(obj.getString("heading"));
                                    newsItem.setThumbnailUrl(obj.getString("image"));
                                    newsItem.setContent(obj.getString("content"));

                                    newsItem.setDateAdded(obj.getString("dateAdded"));
        ...
        getActionBar().setIcon(R.drawable.ic_news_white);
        ...
        customDrawerAdapter = new CustomDrawerAdapter(this, R.layout.custom_drawer_item,dataList);
    ...
    public void SelectItem(int position)
    {
...

        {
            ...
            Toast.makeText(this, "You are currently viewing the newsfeed", Toast.LENGTH_SHORT).show();
