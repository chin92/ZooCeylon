...
public class Games extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_games);
        addListenerOnButton();

        try{
            // Initializing
            getActionBar().setTitle("Games");
            getActionBar().setIcon(R.drawable.ic_games);
        }
    ...
    public void addListenerOnButton() {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context,advancedquizsub.class);
                startActivity(intent);
    ...
    public void SelectItem(int position)
    {
...

        {
            ...
            Toast.makeText(this, "You are currently on play games section", Toast.LENGTH_SHORT).show();
