package com.android.ZooCeylon.com.android.ZooCeylon.Tharini;
...
public class Animals extends MainActivity {private DrawerLayout mDrawerLayout; // defining the drawerLayout
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                setContentView(R.layout.see_zoo_animal);
            }
        });
        /*bt.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        // Initializing
       // getActionBar().setTitle("Animals");
        //getActionBar().setIcon(R.drawable.ic_animals);
    ...
    public void SelectItem(int position)
    {
...

        {
            ...
            Toast.makeText(this, "You are currently on Animals page", Toast.LENGTH_SHORT).show();
