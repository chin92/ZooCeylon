...
import com.android.ZooCeylon.ZoomOutPageTransformer;
...
public class Events extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getActionBar().setIcon(R.drawable.ic_events);
    ...
    public void SelectItem(int position)
    {
...

        {
            ...
            Toast.makeText(this, "You are currently on events page", Toast.LENGTH_SHORT).show();
...
class myAdaptor extends FragmentPagerAdapter
{
    ...
    public android.support.v4.app.Fragment getItem(int position) {
        ...
        if (position==0)
            fragment=new Frag_Events_Today();
        if (position==1)
            fragment=new Frag_Events_Calendar();
        return fragment;
    }
