...
public class Contact extends MainActivity {private DrawerLayout mDrawerLayout; // defining the drawerLayout
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_contact);
    ...
    public void SelectItem(int position)
    {
...

        {
            ...
            Toast.makeText(this, "You are currently on contact information page", Toast.LENGTH_SHORT).show();
